...
public class CalculatorTestA {
    ...
    @DataProvider(name = "setOfNumbers", parallel = true)
    ...
    @Test(groups = "smoke")
    public void addTest145() throws InterruptedException {
        int a = 145;
    ...
    @Test
    @Parameters("int1")
    public void addTest43(int a) throws InterruptedException {
        int expectedResult = calculator.getResult() + a;
        int actualResult = calculator.add(a);
        Thread.sleep(3000);
        assertEquals(actualResult, expectedResult);
    ...
    @Test(groups = "smoke", dataProvider = "setOfNumbers")
    public void multiplyTest78(Integer a) throws InterruptedException {
        int expectedResult = calculator.getResult() * a;
    ...
    @Test
    @Parameters("int1")
    public void multiplyTest2(int a) throws InterruptedException {
        int expectedResult = calculator.getResult() * a;
        int actualResult = calculator.multiply(a);
        Thread.sleep(3000);
        assertEquals(actualResult, expectedResult);
    ...
    @Test(groups = "smoke")
    public void divisionTest48() throws InterruptedException {
        int a = 48;
        int expectedResult = calculator.getResult() / a;
    ...
    public void divisionTest7(Integer a) throws InterruptedException {
        int expectedResult = calculator.getResult() / a;
        int actualResult = calculator.division(a);
        Thread.sleep(3000);
        assertEquals(actualResult, expectedResult);
    ...
    @Test
    public void subtractTest96() throws InterruptedException {
        int a = 96;
        int expectedResult = calculator.getResult() - a;
        int actualResult = calculator.subtract(a);
        Thread.sleep(3000);
    ...
    @Test(groups = "smoke")
    @Parameters("int3")
    public void subtractTest485_367(int a) throws InterruptedException {
        int b = 367;
        int expectedResult = a - b;
    ...
    public void subtractTest975_1286() throws InterruptedException {
        ...
        int actualResult = calculator.subtract(a, b);
        Thread.sleep(3000);
        Assert.assertTrue(calculator.isResultNegative(actualResult));
    }
}